...
export '../generated/cs_nerva_interface_impl.dart';

abstract class CsNervaInterface {
  const CsNervaInterface();
  ...
  // Nerva uses the standard 25-word Monero mnemonic scheme/wordlist.
